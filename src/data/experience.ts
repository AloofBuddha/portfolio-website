...
export const experience: Experience[] = [
  {
    ...
    description: 'Led frontend development for financial products and design system initiatives.',
    achievements: [
  ...
  },
  {
    ...
    description: 'Taught modern full-stack development at a not-for-profit helping military veterans transition to software careers.',
    achievements: [
  ...
  },
  {
    ...
    technologies: ['React', 'React Native', 'TypeScript', 'MUI', 'Jest', 'Cypress'],
  },
  {
    type: 'work',
    ...
    description: 'Delivered full redesign of flagship brand sites and checkout flow.',
    achievements: [
  ...
  },
  {
    ...
    description: 'Early engineer/instructor at one of the first major coding bootcamps.',
    achievements: [
