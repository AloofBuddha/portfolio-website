  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Bio */}
        <div className="text-gray-700 dark:text-gray-300 space-y-4 mb-12">
          <p className="text-lg">
            I'm a{" "}
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {skills.map((skill, index) => (
              <div
                key={index}
                className="glass-card border border-gray-200 dark:border-slate-700 rounded-lg p-4 hover:border-red-500 dark:hover:border-cyan-400 transition-colors shadow-sm text-center"
              >
